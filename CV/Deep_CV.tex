...
{\it Ph.D. in Mathematics}, Tata Institute of Fundamental Research (TIFR-CAM)
 ...
 \item Advisors: Dr. Praveen Chandrashekar (TIFR-CAM) and Prof. Siddhartha Mishra (ETH Zurich and adjunct faculty TIFR-CAM)
  \item Developed and analysed a high-order entropy stable parallelized finite volume solver for the compressible Euler and Navier-Stokes equations on unstructured meshes. Coupled this solver with Monte-Carlo techniques to study the measure valued solutions in the limit of vanishing physical viscosity. 
